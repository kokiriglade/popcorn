...
public class BarrelGui extends NamedGui implements MergedGui, InventoryBased {
     ...
     * @since 3.0.0
     */
    public BarrelGui(@NonNull Component title) {
        super(title);
    }
     ...
     * @since 3.0.0
     */
    public BarrelGui(@NonNull Component title, @NonNull Plugin plugin) {
        super(title, plugin);
    }
    ...
    public BarrelGui copy() {
        BarrelGui gui = new BarrelGui(getTitle(), super.plugin);
