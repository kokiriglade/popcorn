...
public class BarrelGui extends NamedGui implements MergedGui, InventoryBased {
     ...
     * @since 3.0.0
     */
    public BarrelGui(final @NonNull Component title) {
        super(title);
    }
     ...
     * @see #BarrelGui(Component)
     * @since 3.0.0
     */
    public BarrelGui(final @NonNull Component title, final @NonNull Plugin plugin) {
        super(title, plugin);
    }
    ...
    @Contract(pure = true)
    @Override
    public @NonNull BarrelGui copy() {
        final BarrelGui gui = new BarrelGui(getTitle(), super.plugin);
    ...
    public @NonNull Inventory createInventory() {
        return Bukkit.createInventory(this, InventoryType.BARREL, getTitle());
    }
