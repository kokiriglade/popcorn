...
public class DropperGui extends NamedGui implements InventoryBased {
     ...
     * @since 3.0.0
     */
    public DropperGui(final @NonNull Component title) {
        super(title);
    }
     ...
     * @see #DropperGui(Component)
     * @since 3.0.0
     */
    public DropperGui(final @NonNull Component title, final @NonNull Plugin plugin) {
        super(title, plugin);
    }
    ...
    @Contract(pure = true)
    @Override
    public @NonNull DropperGui copy() {
        final DropperGui gui = new DropperGui(getTitle(), super.plugin);
    ...
    public @NonNull Inventory createInventory() {
        final Inventory inventory = Bukkit.createInventory(this, InventoryType.DROPPER, getTitle());
