...
public class DropperGui extends NamedGui implements InventoryBased {
     ...
     * @since 3.0.0
     */
    public DropperGui(@NonNull Component title) {
        super(title);
    }
     ...
     * @since 3.0.0
     */
    public DropperGui(@NonNull Component title, @NonNull Plugin plugin) {
        super(title, plugin);
    }
    ...
    public DropperGui copy() {
        DropperGui gui = new DropperGui(getTitle(), super.plugin);
    ...
    public Inventory createInventory() {
        Inventory inventory = Bukkit.createInventory(this, InventoryType.DROPPER, getTitle());
