...
public class SmokerGui extends NamedGui implements InventoryBased {
     ...
     * @since 3.0.0
     */
    public SmokerGui(final @NonNull Component title) {
        super(title);
    }
     ...
     * @see #SmokerGui(Component)
     * @since 3.0.0
     */
    public SmokerGui(final @NonNull Component title, final @NonNull Plugin plugin) {
        super(title, plugin);
    }
    ...
    @Contract(pure = true)
    @Override
    public @NonNull SmokerGui copy() {
        final SmokerGui gui = new SmokerGui(getTitle(), super.plugin);
    ...
    public @NonNull Inventory createInventory() {
        return Bukkit.createInventory(this, InventoryType.SMOKER, getTitle());
    }
