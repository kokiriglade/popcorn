...
public class SmokerGui extends NamedGui implements InventoryBased {
     ...
     * @since 3.0.0
     */
    public SmokerGui(@NonNull Component title) {
        super(title);
    }
     ...
     * @since 3.0.0
     */
    public SmokerGui(@NonNull Component title, @NonNull Plugin plugin) {
        super(title, plugin);
    }
    ...
    public SmokerGui copy() {
        SmokerGui gui = new SmokerGui(getTitle(), super.plugin);
