...
public class Pattern {
     ...
     */
    private final int @NonNull [] @NonNull [] pattern;
     ...
     * @since 3.0.0
     */
    public Pattern(@NonNull String @NonNull ... pattern) {
     ...
     * @since 3.0.0
     */
    private Pattern(int @NonNull [] @NonNull [] pattern) {
     ...
     */
    @Contract(pure = true)
    public int @NonNull [] getColumn(int index) {
        if (index >= getLength()) {
     ...
     */
    @Contract(pure = true)
    public int @NonNull [] getRow(int index) {
        if (index >= getHeight()) {
