...
public class GeometryUtil {
     ...
     */
    @Contract(pure = true)
    public static Map.@NonNull Entry<Integer, Integer> processClockwiseRotation(int x, int y, int length, int height,
                                                                                int rotation) {
        int newX = x, newY = y;
     ...
     */
    @Contract(pure = true)
    public static Map.@NonNull Entry<Integer, Integer> processCounterClockwiseRotation(int x, int y, int length, int height,
                                                                                       int rotation) {
